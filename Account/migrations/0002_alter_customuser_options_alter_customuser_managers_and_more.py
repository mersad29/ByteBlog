...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customuser',
            name='about_me',
            field=ckeditor.fields.RichTextField(default=1, verbose_name='درباه من(نمایش در بخش درباه من)'),
        ...
        migrations.AddField(
            model_name='customuser',
            name='instagram',
            field=models.CharField(default=1, max_length=250, verbose_name='اینستاگرام'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='customuser',
        ...
        migrations.AlterField(
            model_name='customuser',
            name='phone',
            field=models.CharField(max_length=14, unique=True, verbose_name='شماره تلفن'),
        ),
    ]
